...
import com.example.sneakerhead.model.ProductModel
...
class ProductRepositoryImplementation : ProductRepository {
    ...
    private val cloudinary = Cloudinary(
        mapOf(
            "cloud_name" to "dfbrmiylc",
            "api_key" to "734659242958381",
            "api_secret" to "rm3jjY5Bxe_T1ZsYQUNKabOY1Wc"
        )
    )
        ...
        reference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    callback(products, true, "Products fetched")
                } else {
